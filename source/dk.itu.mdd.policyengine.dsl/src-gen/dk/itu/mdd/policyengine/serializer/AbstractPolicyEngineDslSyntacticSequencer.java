...
public abstract class AbstractPolicyEngineDslSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected AbstractElementAlias match_Room_DuringAllwaysKeyword_3_3_1_q;
	...
	protected void init(IGrammarAccess access) {
		...
		match_Room_DuringAllwaysKeyword_3_3_1_q = new TokenAlias(false, true, grammarAccess.getRoomAccess().getDuringAllwaysKeyword_3_3_1());
	}
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			else if(match_Room_DuringAllwaysKeyword_3_3_1_q.equals(syntax))
				emit_Room_DuringAllwaysKeyword_3_3_1_q(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 *     'during-allways'?
	 */
	protected void emit_Room_DuringAllwaysKeyword_3_3_1_q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
