 ...
 * generated by Xtext
 */
package dk.itu.mdd.policyengine.formatting;
...
public class PolicyEngineDslFormatter extends AbstractDeclarativeFormatter {
  @Inject
  @Extension
  private PolicyEngineDslGrammarAccess _policyEngineDslGrammarAccess;
  
  protected void configureFormatting(final FormattingConfig c) {
    List<Pair<Keyword,Keyword>> _findKeywordPairs = this._policyEngineDslGrammarAccess.findKeywordPairs("{", "}");
    ...
    List<Keyword> _findKeywords = this._policyEngineDslGrammarAccess.findKeywords(",");
    ...
    TerminalRule _sL_COMMENTRule = this._policyEngineDslGrammarAccess.getSL_COMMENTRule();
    _setLinewrap.before(_sL_COMMENTRule);
    LinewrapLocator _setLinewrap_1 = c.setLinewrap(0, 1, 2);
    TerminalRule _mL_COMMENTRule = this._policyEngineDslGrammarAccess.getML_COMMENTRule();
    _setLinewrap_1.before(_mL_COMMENTRule);
    LinewrapLocator _setLinewrap_2 = c.setLinewrap(0, 1, 1);
    TerminalRule _mL_COMMENTRule_1 = this._policyEngineDslGrammarAccess.getML_COMMENTRule();
