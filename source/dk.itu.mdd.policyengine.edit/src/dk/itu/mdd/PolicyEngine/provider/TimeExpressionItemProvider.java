...
/**
 * This is the item provider adapter for a {@link dk.itu.mdd.PolicyEngine.TimeExpression} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TimeExpressionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TimeExpression_seconds_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TimeExpression_seconds_feature", "_UI_TimeExpression_type"),
				 PolicyEnginePackage.Literals.TIME_EXPRESSION__SECONDS,
				 true,
				 false,
				 false,
	...
	protected void addTimePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TimeExpression_time_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TimeExpression_time_feature", "_UI_TimeExpression_type"),
				 PolicyEnginePackage.Literals.TIME_EXPRESSION__TIME,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		...
		return getString("_UI_TimeExpression_type") + " " + timeExpression.getSeconds();
	}
