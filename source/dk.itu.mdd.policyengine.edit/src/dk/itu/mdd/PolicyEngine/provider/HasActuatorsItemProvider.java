...
/**
 * This is the item provider adapter for a {@link dk.itu.mdd.PolicyEngine.HasActuators} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HasActuatorsItemProvider
	 ...
	 * @generated
	 */
	public HasActuatorsItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PolicyEnginePackage.Literals.HAS_ACTUATORS__ACTUATORS);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/HasActuators"));
	}
	...
	public String getText(Object object) {
		return getString("_UI_HasActuators_type");
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(HasActuators.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PolicyEnginePackage.Literals.HAS_ACTUATORS__ACTUATORS,
