...
/**
 * This is the item provider adapter for a {@link dk.itu.mdd.PolicyEngine.HasSensors} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HasSensorsItemProvider
	 ...
	 * @generated
	 */
	public HasSensorsItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PolicyEnginePackage.Literals.HAS_SENSORS__SENSORS);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/HasSensors"));
	}
	...
	public String getText(Object object) {
		return getString("_UI_HasSensors_type");
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(HasSensors.class)) {
			case PolicyEnginePackage.HAS_SENSORS__SENSORS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PolicyEnginePackage.Literals.HAS_SENSORS__SENSORS,
