...
/**
 * This is the item provider adapter for a {@link dk.itu.mdd.PolicyEngine.RoomUsage} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RoomUsageItemProvider
	 ...
	 * @generated
	 */
	public RoomUsageItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RoomUsage_defineState_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RoomUsage_defineState_feature", "_UI_RoomUsage_type"),
				 PolicyEnginePackage.Literals.ROOM_USAGE__DEFINE_STATE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PolicyEnginePackage.Literals.ROOM_USAGE__SEN);
			childrenFeatures.add(PolicyEnginePackage.Literals.ROOM_USAGE__ACT);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/RoomUsage"));
	}
	...
	public String getText(Object object) {
		return getString("_UI_RoomUsage_type");
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(RoomUsage.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PolicyEnginePackage.Literals.ROOM_USAGE__SEN,
		...
		newChildDescriptors.add
			(createChildParameter
				(PolicyEnginePackage.Literals.ROOM_USAGE__ACT,
