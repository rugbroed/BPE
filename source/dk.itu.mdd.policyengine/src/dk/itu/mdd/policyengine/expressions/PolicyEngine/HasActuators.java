 ...
 * <ul>
 *   <li>{@link dk.itu.mdd.policyengine.expressions.PolicyEngine.HasActuators#getActuators <em>Actuators</em>}</li>
 * </ul>
 * </p>
 *
 * @see dk.itu.mdd.policyengine.expressions.PolicyEngine.PolicyEnginePackage#getHasActuators()
 * @model
 * @generated
 */
public interface HasActuators extends EObject {
	 ...
	 * @see dk.itu.mdd.policyengine.expressions.PolicyEngine.PolicyEnginePackage#getHasActuators_Actuators()
