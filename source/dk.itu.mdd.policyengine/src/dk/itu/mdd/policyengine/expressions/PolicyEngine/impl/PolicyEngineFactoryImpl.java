...
public class PolicyEngineFactoryImpl extends EFactoryImpl implements PolicyEngineFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case PolicyEnginePackage.AUDIO_ALARM_TIMER: return createAudioAlarmTimer();
			case PolicyEnginePackage.CLAUSE: return createClause();
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			...
			case PolicyEnginePackage.OPERATORS:
	 ...
	 * @generated
	 */
	public AudioAlarmTimer createAudioAlarmTimer() {
		AudioAlarmTimerImpl audioAlarmTimer = new AudioAlarmTimerImpl();
		return audioAlarmTimer;
	}
