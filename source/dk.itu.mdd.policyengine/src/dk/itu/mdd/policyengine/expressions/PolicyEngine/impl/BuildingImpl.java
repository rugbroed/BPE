 ...
 * <ul>
 *   <li>{@link dk.itu.mdd.policyengine.expressions.PolicyEngine.impl.BuildingImpl#getCtsSystem <em>Cts System</em>}</li>
 *   <li>{@link dk.itu.mdd.policyengine.expressions.PolicyEngine.impl.BuildingImpl#getAccessControl <em>Access Control</em>}</li>
 *   <li>{@link dk.itu.mdd.policyengine.expressions.PolicyEngine.impl.BuildingImpl#getCalendarSystem <em>Calendar System</em>}</li>
 *   <li>{@link dk.itu.mdd.policyengine.expressions.PolicyEngine.impl.BuildingImpl#getMeetingScheduleSystem <em>Meeting Schedule System</em>}</li>
 *   <li>{@link dk.itu.mdd.policyengine.expressions.PolicyEngine.impl.BuildingImpl#getFloors <em>Floors</em>}</li>
 *   <li>{@link dk.itu.mdd.policyengine.expressions.PolicyEngine.impl.BuildingImpl#getTimers <em>Timers</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
