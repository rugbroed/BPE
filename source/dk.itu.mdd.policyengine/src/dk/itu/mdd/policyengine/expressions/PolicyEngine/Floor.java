 ...
 * <ul>
 *   <li>{@link dk.itu.mdd.policyengine.expressions.PolicyEngine.Floor#getRooms <em>Rooms</em>}</li>
 *   <li>{@link dk.itu.mdd.policyengine.expressions.PolicyEngine.Floor#getTimers <em>Timers</em>}</li>
 * </ul>
 * </p>
 *
 * @see dk.itu.mdd.policyengine.expressions.PolicyEngine.PolicyEnginePackage#getFloor()
 * @model
 * @generated
 */
public interface Floor extends NamedElement {
	 ...
	 * @see dk.itu.mdd.policyengine.expressions.PolicyEngine.PolicyEnginePackage#getFloor_Rooms()
	 ...
	 * @see dk.itu.mdd.policyengine.expressions.PolicyEngine.PolicyEnginePackage#getFloor_Timers()
	 * @model containment="true"
	 * @generated
	 */
