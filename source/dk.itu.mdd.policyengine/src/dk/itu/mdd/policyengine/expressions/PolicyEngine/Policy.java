 ...
 * <ul>
 *   <li>{@link dk.itu.mdd.policyengine.expressions.PolicyEngine.Policy#getUses <em>Uses</em>}</li>
 *   <li>{@link dk.itu.mdd.policyengine.expressions.PolicyEngine.Policy#getUsesSensors <em>Uses Sensors</em>}</li>
 *   <li>{@link dk.itu.mdd.policyengine.expressions.PolicyEngine.Policy#getSpecifiedBy <em>Specified By</em>}</li>
 * </ul>
 * </p>
 *
 * @see dk.itu.mdd.policyengine.expressions.PolicyEngine.PolicyEnginePackage#getPolicy()
 * @model
 * @generated
 */
public interface Policy extends NamedElement {
	 ...
	 * @see dk.itu.mdd.policyengine.expressions.PolicyEngine.PolicyEnginePackage#getPolicy_Uses()
	 ...
	 * @see dk.itu.mdd.policyengine.expressions.PolicyEngine.PolicyEnginePackage#getPolicy_UsesSensors()
	 * @model containment="true"
	 * @generated
	 */
	 ...
	 * The list contents are of type {@link dk.itu.mdd.policyengine.expressions.PolicyEngine.If}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see dk.itu.mdd.policyengine.expressions.PolicyEngine.PolicyEnginePackage#getPolicy_SpecifiedBy()
