...
public class PolicyEngineSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case PolicyEnginePackage.AUDIO_ALARM_TIMER: {
				AudioAlarmTimer audioAlarmTimer = (AudioAlarmTimer)theEObject;
				T result = caseAudioAlarmTimer(audioAlarmTimer);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PolicyEnginePackage.CLAUSE: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Audio Alarm Timer</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Audio Alarm Timer</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAudioAlarmTimer(AudioAlarmTimer object) {
		return null;
	}
