 ...
 * <ul>
 *   <li>{@link dk.itu.mdd.policyengine.Time.impl.TimeImpl#getHours <em>Hours</em>}</li>
 *   <li>{@link dk.itu.mdd.policyengine.Time.impl.TimeImpl#getMinutes <em>Minutes</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TimeImpl extends MinimalEObjectImpl.Container implements Time {
	...
	public void setHours(short newHours) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TimePackage.TIME__HOURS, oldHours, hours));
	}
	...
	public void setMinutes(short newMinutes) {
		...
		minutes = newMinutes;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TimePackage.TIME__MINUTES, oldMinutes, minutes));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TimePackage.TIME__HOURS:
				return getHours();
			case TimePackage.TIME__MINUTES:
				return getMinutes();
		}
