 ...
 * <ul>
 *   <li>{@link dk.itu.mdd.policyengine.PolicyEngine.impl.CTSImpl#getTemperatureSensors <em>Temperature Sensors</em>}</li>
 *   <li>{@link dk.itu.mdd.policyengine.PolicyEngine.impl.CTSImpl#getCtsActuators <em>Cts Actuators</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class CTSImpl extends EObjectImpl implements CTS {
	/**
	 ...
	 * @ordered
	 */
	protected EList<TemperatureSensor> temperatureSensors;
	 ...
	 * @generated
	 */
	public EList<TemperatureSensor> getTemperatureSensors() {
		if (temperatureSensors == null) {
			temperatureSensors = new EObjectContainmentEList<TemperatureSensor>(TemperatureSensor.class, this, PolicyEnginePackage.CTS__TEMPERATURE_SENSORS);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case PolicyEnginePackage.CTS__TEMPERATURE_SENSORS:
				...
				getTemperatureSensors().addAll((Collection<? extends TemperatureSensor>)newValue);
				return;
			case PolicyEnginePackage.CTS__CTS_ACTUATORS:
