 ...
 * <ul>
 *   <li>{@link dk.itu.mdd.policyengine.PolicyEngine.impl.AccessControlImpl#getAccessControlSensors <em>Access Control Sensors</em>}</li>
 *   <li>{@link dk.itu.mdd.policyengine.PolicyEngine.impl.AccessControlImpl#getAccessControlDoorLockActuator <em>Access Control Door Lock Actuator</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AccessControlImpl extends EObjectImpl implements AccessControl {
	 ...
	 * @ordered
	 */
	protected EList<SensorType> accessControlSensors;
	 ...
	 * @ordered
	 */
	protected EList<DoorActuator> accessControlDoorLockActuator;
	 ...
	 * @generated
	 */
	public EList<SensorType> getAccessControlSensors() {
		if (accessControlSensors == null) {
			accessControlSensors = new EObjectContainmentEList<SensorType>(SensorType.class, this, PolicyEnginePackage.ACCESS_CONTROL__ACCESS_CONTROL_SENSORS);
		}
	 ...
	 * @generated
	 */
	public EList<DoorActuator> getAccessControlDoorLockActuator() {
		if (accessControlDoorLockActuator == null) {
			accessControlDoorLockActuator = new EObjectContainmentEList<DoorActuator>(DoorActuator.class, this, PolicyEnginePackage.ACCESS_CONTROL__ACCESS_CONTROL_DOOR_LOCK_ACTUATOR);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case PolicyEnginePackage.ACCESS_CONTROL__ACCESS_CONTROL_SENSORS:
				...
				getAccessControlSensors().addAll((Collection<? extends SensorType>)newValue);
				return;
			case PolicyEnginePackage.ACCESS_CONTROL__ACCESS_CONTROL_DOOR_LOCK_ACTUATOR:
				getAccessControlDoorLockActuator().clear();
				getAccessControlDoorLockActuator().addAll((Collection<? extends DoorActuator>)newValue);
				return;
		}
