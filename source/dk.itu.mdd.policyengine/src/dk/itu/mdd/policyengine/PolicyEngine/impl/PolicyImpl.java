 ...
 * <ul>
 *   <li>{@link dk.itu.mdd.policyengine.PolicyEngine.impl.PolicyImpl#getUsesActuators <em>Uses Actuators</em>}</li>
 *   <li>{@link dk.itu.mdd.policyengine.PolicyEngine.impl.PolicyImpl#getSpecifiedBy <em>Specified By</em>}</li>
 *   <li>{@link dk.itu.mdd.policyengine.PolicyEngine.impl.PolicyImpl#getDefineState <em>Define State</em>}</li>
 *   <li>{@link dk.itu.mdd.policyengine.PolicyEngine.impl.PolicyImpl#getDuring <em>During</em>}</li>
 *   <li>{@link dk.itu.mdd.policyengine.PolicyEngine.impl.PolicyImpl#getUsesRooms <em>Uses Rooms</em>}</li>
...
public class PolicyImpl extends NamedElementImpl implements Policy {
	 ...
	 * @ordered
	 */
	protected EList<Statement> specifiedBy;
	 ...
	 * @generated
	 */
	public EList<Statement> getSpecifiedBy() {
		if (specifiedBy == null) {
			specifiedBy = new EObjectContainmentEList<Statement>(Statement.class, this, PolicyEnginePackage.POLICY__SPECIFIED_BY);
		}
		return specifiedBy;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case PolicyEnginePackage.POLICY__SPECIFIED_BY:
				...
				getSpecifiedBy().addAll((Collection<? extends Statement>)newValue);
				return;
			case PolicyEnginePackage.POLICY__DEFINE_STATE:
