 ...
 * <ul>
 *   <li>{@link dk.itu.mdd.policyengine.PolicyEngine.HasSensors#getSensors <em>Sensors</em>}</li>
 * </ul>
 * </p>
 *
 * @see dk.itu.mdd.policyengine.PolicyEngine.PolicyEnginePackage#getHasSensors()
 * @model
 * @generated
 */
public interface HasSensors extends EObject {
	 ...
	 * @see dk.itu.mdd.policyengine.PolicyEngine.PolicyEnginePackage#getHasSensors_Sensors()
