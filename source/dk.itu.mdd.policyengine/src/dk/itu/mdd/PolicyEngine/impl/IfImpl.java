 ...
 * <ul>
 *   <li>{@link dk.itu.mdd.PolicyEngine.impl.IfImpl#getCond <em>Cond</em>}</li>
 *   <li>{@link dk.itu.mdd.PolicyEngine.impl.IfImpl#getThen <em>Then</em>}</li>
 *   <li>{@link dk.itu.mdd.PolicyEngine.impl.IfImpl#getElseif <em>Elseif</em>}</li>
 *   <li>{@link dk.itu.mdd.PolicyEngine.impl.IfImpl#getElse <em>Else</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfImpl extends MinimalEObjectImpl.Container implements If {
	...
	public EList<If> getElseif() {
		if (elseif == null) {
			elseif = new EObjectContainmentEList<If>(If.class, this, PolicyEnginePackage.IF__ELSEIF);
		}
		return elseif;
	}
