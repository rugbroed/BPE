 ...
 * <ul>
 *   <li>{@link dk.itu.mdd.PolicyEngine.impl.ModelImpl#getBuildings <em>Buildings</em>}</li>
 *   <li>{@link dk.itu.mdd.PolicyEngine.impl.ModelImpl#getPredefinedRooms <em>Predefined Rooms</em>}</li>
 *   <li>{@link dk.itu.mdd.PolicyEngine.impl.ModelImpl#getPolicyDefinition <em>Policy Definition</em>}</li>
 *   <li>{@link dk.itu.mdd.PolicyEngine.impl.ModelImpl#getStateDefinition <em>State Definition</em>}</li>
 *   <li>{@link dk.itu.mdd.PolicyEngine.impl.ModelImpl#getTimers <em>Timers</em>}</li>
 *   <li>{@link dk.itu.mdd.PolicyEngine.impl.ModelImpl#getSchedules <em>Schedules</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
