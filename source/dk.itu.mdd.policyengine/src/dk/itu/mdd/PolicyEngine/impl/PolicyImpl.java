...
public class PolicyImpl extends NamedElementImpl implements Policy {
	 ...
	 * @ordered
	 */
	protected EList<Actuator> usesActuators;
	 ...
	 * @generated
	 */
	public EList<Actuator> getUsesActuators() {
		if (usesActuators == null) {
			usesActuators = new EObjectContainmentEList<Actuator>(Actuator.class, this, PolicyEnginePackage.POLICY__USES_ACTUATORS);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case PolicyEnginePackage.POLICY__USES_ACTUATORS:
				...
				getUsesActuators().addAll((Collection<? extends Actuator>)newValue);
				return;
			case PolicyEnginePackage.POLICY__USES_SENSORS:
