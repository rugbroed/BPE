...
import dk.itu.mdd.PolicyEngine.HasSensors;
...
public class PolicyEnginePackageImpl extends EPackageImpl implements PolicyEnginePackage {
	...
	public void initializePackageContents() {
		...
		initEReference(getCTS_TemperatureSensors(), this.getSensor(), null, "temperatureSensors", null, 0, -1, dk.itu.mdd.PolicyEngine.CTS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getPolicy_UsesActuators(), this.getActuator(), null, "usesActuators", null, 0, -1, Policy.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getRoomUsage_Sen(), this.getSensor(), null, "sen", null, 0, 1, RoomUsage.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRoomUsage_Act(), this.getActuator(), null, "act", null, 0, 1, RoomUsage.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
