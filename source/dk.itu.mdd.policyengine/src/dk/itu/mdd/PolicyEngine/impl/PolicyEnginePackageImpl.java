...
import dk.itu.mdd.PolicyEngine.ElectricalSwitchActuator;
import dk.itu.mdd.PolicyEngine.Expression;
import dk.itu.mdd.PolicyEngine.Floor;
import dk.itu.mdd.PolicyEngine.GasValveActuator;
import dk.itu.mdd.PolicyEngine.HasIntegerValue;
...
import dk.itu.mdd.PolicyEngine.NamedElement;
...
import dk.itu.mdd.PolicyEngine.RainSensor;
...
import dk.itu.mdd.PolicyEngine.WaterValveActuator;
import dk.itu.mdd.PolicyEngine.Weekdays;
...
public class PolicyEnginePackageImpl extends EPackageImpl implements PolicyEnginePackage {
	 ...
	 * @generated
	 */
	private EClass roomUsageEClass = null;
	 ...
	 * @see dk.itu.mdd.PolicyEngine.PolicyEnginePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EReference getPolicy_ControlledBy() {
	 ...
	 * @generated
	 */
	public EReference getPolicy_DefineLocalState() {
	 ...
	 * @generated
	 */
	public EClass getRoomUsage() {
		return roomUsageEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getRoomUsage_Sen() {
		return (EReference)roomUsageEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getRoomUsage_Act() {
		return (EReference)roomUsageEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getRoomUsage_DefineState() {
		return (EReference)roomUsageEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EReference getRoomUsage_RoomInstance() {
		return (EReference)roomUsageEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EReference getRoomUsage_Instance() {
		return (EReference)roomUsageEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 * @generated
	 */
	public EReference getManyExpressions_LeftExpr() {
	 ...
	 * @generated
	 */
	public EReference getManyExpressions_RightExpr() {
		return (EReference)manyExpressionsEClass.getEStructuralFeatures().get(1);
	}
	...
	public EAttribute getManyExpressions_Operator() {
		return (EAttribute)manyExpressionsEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EAttribute getCompExpression_Operand() {
	...
	public void createPackageContents() {
		...
		createEReference(policyEClass, POLICY__CONTROLLED_BY);
		...
		createEReference(policyEClass, POLICY__DEFINE_LOCAL_STATE);
		...
		roomUsageEClass = createEClass(ROOM_USAGE);
		createEReference(roomUsageEClass, ROOM_USAGE__SEN);
		createEReference(roomUsageEClass, ROOM_USAGE__ACT);
		createEReference(roomUsageEClass, ROOM_USAGE__DEFINE_STATE);
		createEReference(roomUsageEClass, ROOM_USAGE__ROOM_INSTANCE);
		createEReference(roomUsageEClass, ROOM_USAGE__INSTANCE);

		expressionEClass = createEClass(EXPRESSION);

		manyExpressionsEClass = createEClass(MANY_EXPRESSIONS);
		createEReference(manyExpressionsEClass, MANY_EXPRESSIONS__LEFT_EXPR);
		createEReference(manyExpressionsEClass, MANY_EXPRESSIONS__RIGHT_EXPR);
		...
		createEAttribute(compExpressionEClass, COMP_EXPRESSION__OPERAND);
	...
	public void initializePackageContents() {
		...
		actuatorTypeEClass.getESuperTypes().add(this.getHasIntegerValue());
		...
		sensorTypeEClass.getESuperTypes().add(this.getHasIntegerValue());
		...
		initEClass(ctsEClass, dk.itu.mdd.PolicyEngine.CTS.class, "CTS", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getCTS_TemperatureSensors(), this.getTemperatureSensor(), null, "temperatureSensors", null, 0, -1, dk.itu.mdd.PolicyEngine.CTS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCTS_CtsActuators(), this.getActuator(), null, "ctsActuators", null, 0, -1, dk.itu.mdd.PolicyEngine.CTS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getPolicy_ControlledBy(), this.getTimer(), null, "controlledBy", null, 0, -1, Policy.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getPolicy_DefineLocalState(), this.getState(), null, "defineLocalState", null, 0, -1, Policy.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getIf_Elseif(), this.getIf(), null, "elseif", null, 0, -1, If.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(roomUsageEClass, RoomUsage.class, "RoomUsage", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getRoomUsage_Sen(), this.getSensorType(), null, "sen", null, 0, 1, RoomUsage.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRoomUsage_Act(), this.getActuatorType(), null, "act", null, 0, 1, RoomUsage.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRoomUsage_DefineState(), this.getState(), null, "defineState", null, 0, 1, RoomUsage.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRoomUsage_RoomInstance(), this.getRoom(), null, "roomInstance", null, 0, 1, RoomUsage.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRoomUsage_Instance(), this.getComponent(), null, "instance", null, 0, 1, RoomUsage.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getManyExpressions_LeftExpr(), this.getExpression(), null, "leftExpr", null, 1, 1, ManyExpressions.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getManyExpressions_RightExpr(), this.getExpression(), null, "rightExpr", null, 1, 1, ManyExpressions.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getManyExpressions_Operator(), ecorePackage.getEString(), "operator", null, 1, 1, ManyExpressions.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(compExpressionEClass, CompExpression.class, "CompExpression", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getCompExpression_Expr(), this.getRoomUsage(), null, "expr", null, 1, 1, CompExpression.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCompExpression_Operand(), this.getCompOps(), "operand", null, 1, 1, CompExpression.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
