...
public class PolicyEnginePackageImpl extends EPackageImpl implements PolicyEnginePackage {
	 ...
	 * @generated
	 */
	public EReference getRoomUsage_DefinedRooms() {
	 ...
	 * @generated
	 */
	public EAttribute getCompExpression_Value() {
	...
	public void createPackageContents() {
		...
		createEReference(roomUsageEClass, ROOM_USAGE__DEFINED_ROOMS);
		...
		createEAttribute(compExpressionEClass, COMP_EXPRESSION__VALUE);
	...
	public void initializePackageContents() {
		...
		initEReference(getRoomUsage_DefinedRooms(), this.getRoom(), null, "definedRooms", null, 0, 1, RoomUsage.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getCompExpression_Value(), ecorePackage.getEInt(), "Value", null, 1, 1, CompExpression.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
