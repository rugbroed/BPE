 ...
 *   <li>{@link dk.itu.mdd.PolicyEngine.CompExpression#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
...
public interface CompExpression extends Expression {
	 ...
	 * @see #setValue(int)
	 * @see dk.itu.mdd.PolicyEngine.PolicyEnginePackage#getCompExpression_Value()
	 * @model required="true"
	 * @generated
	 */
	int getValue();
	...
	/**
	 * Sets the value of the '{@link dk.itu.mdd.PolicyEngine.CompExpression#getValue <em>Value</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
