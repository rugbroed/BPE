 ...
 * <ul>
 *   <li>{@link dk.itu.mdd.PolicyEngine.Model#getBuildings <em>Buildings</em>}</li>
 *   <li>{@link dk.itu.mdd.PolicyEngine.Model#getPredefinedRooms <em>Predefined Rooms</em>}</li>
 *   <li>{@link dk.itu.mdd.PolicyEngine.Model#getPolicyDefinition <em>Policy Definition</em>}</li>
 *   <li>{@link dk.itu.mdd.PolicyEngine.Model#getStateDefinition <em>State Definition</em>}</li>
 *   <li>{@link dk.itu.mdd.PolicyEngine.Model#getTimers <em>Timers</em>}</li>
 *   <li>{@link dk.itu.mdd.PolicyEngine.Model#getSchedules <em>Schedules</em>}</li>
 * </ul>
 * </p>
 *
 * @see dk.itu.mdd.PolicyEngine.PolicyEnginePackage#getModel()
 * @model
 * @generated
 */
public interface Model extends NamedElement {
	 ...
	 * The list contents are of type {@link dk.itu.mdd.PolicyEngine.Building}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see dk.itu.mdd.PolicyEngine.PolicyEnginePackage#getModel_Buildings()
	 ...
	 * @see dk.itu.mdd.PolicyEngine.PolicyEnginePackage#getModel_PredefinedRooms()
	 * @model containment="true"
	 * @generated
	 */
	 ...
	 * @see dk.itu.mdd.PolicyEngine.PolicyEnginePackage#getModel_PolicyDefinition()
	 * @model containment="true"
	 * @generated
	 */
	 ...
	 * @see dk.itu.mdd.PolicyEngine.PolicyEnginePackage#getModel_StateDefinition()
	 * @model containment="true"
	 * @generated
	 */
	 ...
	 * @see dk.itu.mdd.PolicyEngine.PolicyEnginePackage#getModel_Timers()
	 * @model containment="true"
	 * @generated
	 */
	 ...
	 * @see dk.itu.mdd.PolicyEngine.PolicyEnginePackage#getModel_Schedules()
	 * @model containment="true"
	 * @generated
	 */
