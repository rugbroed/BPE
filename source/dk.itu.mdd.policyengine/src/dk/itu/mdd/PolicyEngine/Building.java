 ...
 * <ul>
 *   <li>{@link dk.itu.mdd.PolicyEngine.Building#getCtsSystem <em>Cts System</em>}</li>
 *   <li>{@link dk.itu.mdd.PolicyEngine.Building#getAccessControl <em>Access Control</em>}</li>
 *   <li>{@link dk.itu.mdd.PolicyEngine.Building#getCalendarSystem <em>Calendar System</em>}</li>
 *   <li>{@link dk.itu.mdd.PolicyEngine.Building#getMeetingScheduleSystem <em>Meeting Schedule System</em>}</li>
 *   <li>{@link dk.itu.mdd.PolicyEngine.Building#getFloors <em>Floors</em>}</li>
 *   <li>{@link dk.itu.mdd.PolicyEngine.Building#getTimers <em>Timers</em>}</li>
 * </ul>
 * </p>
 *
 * @see dk.itu.mdd.PolicyEngine.PolicyEnginePackage#getBuilding()
 * @model
 * @generated
 */
public interface Building extends NamedElement {
	 ...
	 * @see dk.itu.mdd.PolicyEngine.PolicyEnginePackage#getBuilding_CtsSystem()
	...
	/**
	 * Sets the value of the '{@link dk.itu.mdd.PolicyEngine.Building#getCtsSystem <em>Cts System</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see dk.itu.mdd.PolicyEngine.PolicyEnginePackage#getBuilding_AccessControl()
	 * @model containment="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link dk.itu.mdd.PolicyEngine.Building#getAccessControl <em>Access Control</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see dk.itu.mdd.PolicyEngine.PolicyEnginePackage#getBuilding_CalendarSystem()
	 * @model containment="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link dk.itu.mdd.PolicyEngine.Building#getCalendarSystem <em>Calendar System</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see dk.itu.mdd.PolicyEngine.PolicyEnginePackage#getBuilding_MeetingScheduleSystem()
	 * @model containment="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link dk.itu.mdd.PolicyEngine.Building#getMeetingScheduleSystem <em>Meeting Schedule System</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link dk.itu.mdd.PolicyEngine.Floor}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see dk.itu.mdd.PolicyEngine.PolicyEnginePackage#getBuilding_Floors()
	 * @model containment="true"
	 * @generated
	 */
	 ...
	 * @see dk.itu.mdd.PolicyEngine.PolicyEnginePackage#getBuilding_Timers()
	 * @model containment="true"
	 * @generated
	 */
