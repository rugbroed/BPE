...
public class PolicyEngineSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case PolicyEnginePackage.RAIN_SENSOR: {
				...
				if (result == null) result = caseHasIntegerValue(rainSensor);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case PolicyEnginePackage.ACTUATOR_TYPE: {
				...
				if (result == null) result = caseHasIntegerValue(actuatorType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case PolicyEnginePackage.ROOM_USAGE: {
				RoomUsage roomUsage = (RoomUsage)theEObject;
				T result = caseRoomUsage(roomUsage);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case PolicyEnginePackage.MANY_EXPRESSIONS: {
				ManyExpressions manyExpressions = (ManyExpressions)theEObject;
				T result = caseManyExpressions(manyExpressions);
				if (result == null) result = caseExpression(manyExpressions);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PolicyEnginePackage.COMP_EXPRESSION: {
			...
			case PolicyEnginePackage.SENSOR_TYPE: {
				...
				if (result == null) result = caseHasIntegerValue(sensorType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PolicyEnginePackage.ELECTRICAL_SWITCH_ACTUATOR: {
				...
				if (result == null) result = caseHasIntegerValue(electricalSwitchActuator);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PolicyEnginePackage.WATER_VALVE_ACTUATOR: {
				...
				if (result == null) result = caseHasIntegerValue(waterValveActuator);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PolicyEnginePackage.GAS_VALVE_ACTUATOR: {
				...
				if (result == null) result = caseHasIntegerValue(gasValveActuator);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Room Usage</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Room Usage</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseRoomUsage(RoomUsage object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Many Expressions</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Many Expressions</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseManyExpressions(ManyExpressions object) {
		return null;
	}
