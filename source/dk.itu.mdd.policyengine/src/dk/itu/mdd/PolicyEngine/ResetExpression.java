 ...
 * <ul>
 *   <li>{@link dk.itu.mdd.PolicyEngine.ResetExpression#getReset <em>Reset</em>}</li>
 * </ul>
 * </p>
 *
 * @see dk.itu.mdd.PolicyEngine.PolicyEnginePackage#getResetExpression()
 * @model
 * @generated
 */
public interface ResetExpression extends Expression {
	 ...
	 * @see #setReset(Timer)
	 * @see dk.itu.mdd.PolicyEngine.PolicyEnginePackage#getResetExpression_Reset()
	 * @model required="true"
	 * @generated
	 */
	Timer getReset();
	...
	/**
	 * Sets the value of the '{@link dk.itu.mdd.PolicyEngine.ResetExpression#getReset <em>Reset</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
