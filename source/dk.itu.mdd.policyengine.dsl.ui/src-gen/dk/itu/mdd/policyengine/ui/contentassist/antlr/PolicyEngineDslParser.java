		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getModelAccess().getPredefinedRoomsAssignment_5_0(), "rule__Model__PredefinedRoomsAssignment_5_0");
					put(grammarAccess.getModelAccess().getPredefinedRoomsAssignment_5_1(), "rule__Model__PredefinedRoomsAssignment_5_1");
					...
					put(grammarAccess.getPolicyAccess().getUsesSensorsAssignment_4_0(), "rule__Policy__UsesSensorsAssignment_4_0");
