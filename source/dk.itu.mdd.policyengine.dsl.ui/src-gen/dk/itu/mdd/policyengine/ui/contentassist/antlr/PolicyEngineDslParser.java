	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getRoomAccess().getAlternatives_3_3(), "rule__Room__Alternatives_3_3");
					...
					put(grammarAccess.getRoomAccess().getGroup_3_3_0_2(), "rule__Room__Group_3_3_0_2__0");
					...
					put(grammarAccess.getRoomAccess().getDuringAssignment_3_3_0_2_1(), "rule__Room__DuringAssignment_3_3_0_2_1");
