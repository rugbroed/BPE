...
We have included the full DSL implementation of one of the interviewees, Br\"{u}el \& Kj\ae r in \nameref{app:a-metamodel}. Please note that this is a fully working implementation that is running in Eclipse.
