...
During the design and implementation of our metamodel we made many different design decisions, primarily based on the length and scope of this project and revelations from the interviews.
...
\includepdf[pages=1,scale=.8,pagecommand=\section{Appendix C - K\o benhavns Tekniske Skole}\label{app:kts}]{BruelOgKjaer.pdf}
\includepdf[pages=2-,scale=.8,pagecommand={}]{BruelOgKjaer.pdf}
